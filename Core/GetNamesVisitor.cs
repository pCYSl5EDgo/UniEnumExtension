...
//            return ReplaceGetNames(moduleDefinition, systemModuleDefinition, enumTypeDefinition, processor, ref currentInstruction, getTypeFromHandleInstruction, getNamesInstruction, count);
//        }

//        private bool ReplaceGetNames(ModuleDefinition moduleDefinition, ModuleDefinition systemModuleDefinition, TypeDefinition enumTypeDefinition, ILProcessor processor, ref Instruction currentInstruction, Instruction getTypeFromHandleInstruction, Instruction getNamesInstruction, int count)
//        {
//            var privateImplementationDetails = moduleDefinition.GetOrCreatePrivateImplementationDetails(systemModuleDefinition);
//            var fieldDefinition = moduleDefinition.GetOrCreateStaticStringArrayField(privateImplementationDetails, systemModuleDefinition, enumTypeDefinition);
